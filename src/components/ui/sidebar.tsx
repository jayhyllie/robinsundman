...
function readStoredOpen(storageKey: string, fallback: boolean) {
...
function SidebarProvider({
  ...
  /** localStorage key for persisting collapsed/expanded across navigations */
  storageKey?: string
}) {
  ...
  React.useEffect(() => {
    ...
    const stored = readStoredOpen(storageKey, defaultOpen)
    _setOpen(stored)
  }, [storageKey, defaultOpen, openProp])
